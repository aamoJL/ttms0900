	...
	<section>
		...
		<!-- YouTube-soittimen napit -->
			<article id=playerButtons>
				<button class="playerButton" id="play" onclick="playVideo()">Play</button><?php
if($_SESSION["user_name"] == "admin") {?><button class="playerButton" id="skip" onclick="adminChangeVideo('skip')">Skip</button><?php } ?><button class="playerButton" id="mute" onclick="muteVideo()">Mute</button><input id="volume" type=range min="0" max="100" value=100 oninput="changeVolume(this.value)">
			</article>
